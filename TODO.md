...
- La fonction ```astar``` doit renvoyer une liste de tuples(pion, direction) pour pouvoir comparer avec ce que fait le joueur
- J'implémenterai le dessin de la solution optimale quand ce sera fait
